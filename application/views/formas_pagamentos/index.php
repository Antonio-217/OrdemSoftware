            ...
            <tbody>
              <?php foreach ($formas_pagamentos as $forma): ?>
                <tr>
                  ...
                  <td class="text-center h5 pr-4"><?php echo ($forma->forma_pagamento_aceita_parc == 1 ? '<span class="badge badge-primary btn-sm">Sim</span>' : '<span class="badge badge-secondary btn-sm">Não</span>') ?></td>
                  <td class="text-center h5 pr-4"><?php echo ($forma->forma_pagamento_ativa == 1 ? '<span class="badge badge-primary btn-sm">Sim</span>' : '<span class="badge badge-secondary btn-sm">Não</span>') ?></td>
                  <td class="text-right">
                    <a title="Editar" href="<?php echo base_url('formas_pagamentos/edit/'.$forma->forma_pagamento_id) ?>" class="btn btn-sm btn-primary"><i class="fas fa-edit"></i>&nbsp;Editar</a>
                    <a title="Excluir" href="JavaScript(void)" data-toggle="modal" data-target="#forma-<?php echo $forma->forma_pagamento_id; ?>" class="btn btn-sm btn-danger"><i class="fas fa-trash"></i>&nbsp;Excluir</a>
                  </td>
                </tr>
