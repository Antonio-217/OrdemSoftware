            ...
            <legend class="w-auto font-small"><i class="fas fa-user-tag"></i>&nbsp;Dados principais</legend>
              ...
              <div class="form-group row mb-4">
                ...
                <div class="col-md-4">
                  ...
                  <input type="text" class="form-control sp_celphones" name="fornecedor_celular" placeholder="Telefone celular" value="<?php echo $fornecedor->fornecedor_celular; ?>">
              ...
              <legend class="w-auto font-small"><i class="fas fa-cog"></i>&nbsp;Configurações</legend>
                ...
                <div class="form-group row mb-4">
                  ...
                  <div class="col-md-10">
                    ...
                    <textarea type="text" class="form-control" name="fornecedor_obs"><?php echo $fornecedor->fornecedor_obs; ?></textarea>
