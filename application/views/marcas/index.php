            ...
            <tbody>
              <?php foreach ($marcas as $marca): ?>
                <tr>
                  ...
                  <td class="text-center pr-4"><?php echo ($marca->marca_ativa == 1 ? '<span class="badge badge-success btn-sm">Sim</span>' : '<span class="badge badge-danger btn-sm">Não</span>') ?></td>
                  <td class="text-right">
