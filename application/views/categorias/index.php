            ...
            <tbody>
              <?php foreach ($categorias as $categoria): ?>
                <tr>
                  ...
                  <td class="text-center h5 pr-4"><?php echo ($categoria->categoria_ativa == 1 ? '<span class="badge badge-primary btn-sm">Sim</span>' : '<span class="badge badge-secondary btn-sm">Não</span>') ?></td>
                  <td class="text-right">
