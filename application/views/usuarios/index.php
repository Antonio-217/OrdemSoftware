            ...
            <tbody>
              <?php foreach ($usuarios as $user): ?>
                <tr>
                  ...
                  <td class="text-center h5 pr-4"><?php echo ($user->active == 1 ? '<span class="badge badge-primary btn-sm">Sim</span>' : '<span class="badge badge-secondary btn-sm">Não</span>') ?></td>
                  <td class="text-right">
