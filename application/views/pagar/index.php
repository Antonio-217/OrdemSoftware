            ...
            <tbody>
              <?php foreach ($contas_pagar as $conta): ?>
                <tr>
                  ...
                  <td class="text-right">
                    <a title="Editar" href="<?php echo base_url('pagar/edit/'.$conta->conta_pagar_id) ?>" class="btn btn-sm btn-primary"><i class="fas fa-edit"></i>&nbsp;Editar</a>
                    <a title="Excluir" href="JavaScript(void)" data-toggle="modal" data-target="#conta-<?php echo $conta->conta_pagar_id; ?>" class="btn btn-sm btn-danger"><i class="fas fa-trash"></i>&nbsp;Excluir</a>
                  </td>
                </tr>
