...
class Sistema extends CI_Controller{
    ...
    public function index(){
        ...
        $data = array(
            ...
            'sistema' => $this->ordem_model->get_by_id('sistema', array('sistema_id' => 1)),
        );
        ...
        $this->form_validation->set_rules('sistema_txt_ordem_servico', 'Texto ordem de serivço e venda', 'max_length[800]');
        ...
        if($this->form_validation->run()){
            ...
            $this->ordem_model->update('sistema', $data, array('sistema_id' => 1));
            redirect('sistema');
