...
class Fornecedores extends CI_Controller{
    ...
    public function add(){
        ...
        $this->form_validation->set_rules('fornecedor_cidade', '', 'trim|required|max_length[80]');
        $this->form_validation->set_rules('fornecedor_estado', 'UF', 'trim|exact_length[2]');
        ...
        if($this->form_validation->run()){
            ...
            $this->ordem_model->insert('fornecedores', $data);
    ...
    public function del($fornecedor_id = null){
        ...
        if(!$fornecedor_id || !$this->ordem_model->get_by_id('fornecedores', array('fornecedor_id' => $fornecedor_id))){
            $this->session->set_flashdata('error', 'fornecedor não encontrado');
            redirect('fornecedores');
        } else{
            $this->ordem_model->delete('fornecedores', array('fornecedor_id' => $fornecedor_id));
            redirect('fornecedores');
        }
        ...
        if(!$fornecedor_id || !$this->ordem_model->get_by_id('fornecedores', array('fornecedor_id' => $fornecedor_id))){
            ...
            if($this->form_validation->run()){
                ...
                if($this->db->table_exists('produtos')){
                    ...
                    if($fornecedor_ativo == 0 && $this->ordem_model->get_by_id('produtos', array('produto_fornecedor_id' => $fornecedor_id, 'produto_ativo' => 1))){
                        $this->session->set_flashdata('error', 'Esse fornecedor não pode ser desativado, pois está sendo utilizada em Produtos');
                        redirect('fornecedores');
                    }
                }
                ...
                $this->ordem_model->update('fornecedores', $data, array('fornecedor_id' => $fornecedor_id));
                redirect('fornecedores');
                ...
                $data = array(
                    ...
                    'fornecedor' => $this->ordem_model->get_by_id('fornecedores', array('fornecedor_id' => $fornecedor_id)),
                );
    ...
    public function check_razao_social($fornecedor_razao){
        ...
        if($this->ordem_model->get_by_id('fornecedores', array('fornecedor_razao' => $fornecedor_razao, 'fornecedor_id !=' => $fornecedor_id))){
     ...
     public function check_nome_fantasia($fornecedor_nome_fantasia){
        ...
        if($this->ordem_model->get_by_id('fornecedores', array('fornecedor_nome_fantasia' => $fornecedor_nome_fantasia, 'fornecedor_id !=' => $fornecedor_id))){
    ...
    public function check_ie($fornecedor_ie){
        ...
        if($this->ordem_model->get_by_id('fornecedores', array('fornecedor_ie' => $fornecedor_ie, 'fornecedor_id !=' => $fornecedor_id))){
     ...
     public function check_email($fornecedor_email){
        ...
        if($this->ordem_model->get_by_id('fornecedores', array('fornecedor_email' => $fornecedor_email, 'fornecedor_id !=' => $fornecedor_id))){
     ...
     public function check_telefone($fornecedor_telefone){
        ...
        if($this->ordem_model->get_by_id('fornecedores', array('fornecedor_telefone' => $fornecedor_telefone, 'fornecedor_id !=' => $fornecedor_id))){
     ...
     public function check_celular($fornecedor_celular){
        ...
        if($this->ordem_model->get_by_id('fornecedores', array('fornecedor_celular' => $fornecedor_celular, 'fornecedor_id !=' => $fornecedor_id))){
     ...
     public function valida_cnpj($cnpj) {
        ...
        if ($this->input->post('fornecedor_id')) {
            ...
            if ($this->ordem_model->get_by_id('fornecedores', array('fornecedor_id !=' => $fornecedor_id, 'fornecedor_cnpj' => $cnpj))) {
