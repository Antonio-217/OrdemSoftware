...
class Vendedores extends CI_Controller{
    ...
    public function index(){
        ...
        $data = array(
            ...
            'vendedores' => $this->ordem_model->get_all('vendedores'),
        );
    ...
    public function add(){
        ...
        $this->form_validation->set_rules('vendedor_nome_completo', '', 'trim|required|min_length[4]|max_length[200]');
            ...
            $this->form_validation->set_rules('vendedor_cidade', '', 'trim|required|max_length[80]');
            $this->form_validation->set_rules('vendedor_estado', 'UF', 'trim|exact_length[2]');
            ...
            if($this->form_validation->run()){
                ...
                $this->ordem_model->insert('vendedores', $data);
                redirect('vendedores');
                ...
                $data = array(
                    ...
                    'vendedor_codigo' => $this->ordem_model->generate_unique_code('vendedores', 'numeric', 8, 'vendedor_codigo'),
                );
    ...
    public function edit($vendedor_id = null){
        ...
        if(!$vendedor_id || !$this->ordem_model->get_by_id('vendedores', array('vendedor_id' => $vendedor_id))){
            ...
            if($this->form_validation->run()){
                ...
                $this->ordem_model->update('vendedores', $data, array('vendedor_id' => $vendedor_id));
                redirect('vendedores');
                ...
                $data = array(
                    ...
                    'vendedor' => $this->ordem_model->get_by_id('vendedores', array('vendedor_id' => $vendedor_id)),
                );
    ...
    public function del($vendedor_id = null){
        ...
        if(!$vendedor_id || !$this->ordem_model->get_by_id('vendedores', array('vendedor_id' => $vendedor_id))){
            ...
            $this->ordem_model->delete('vendedores', array('vendedor_id' => $vendedor_id));
            redirect('vendedores');
        }
